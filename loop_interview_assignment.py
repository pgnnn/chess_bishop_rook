...
class Chessboard:
    ...
    #move_piece_with_obstacles function is same as above move_piece function, but with extra functionality
    #while going from start to end position, if we find a chess element, if this element is with a different color we will kill it and assign this as a new position of our element
    # if we find an element which is of the same color, then we will assign just before possible position to our element since bishop or rukh can't cross an existing element. 
